        ...
        <section class="page-section" id="announcements">
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/announcement/1.jpg" alt="..." /></div>
                        <h4 class="my-3">Premium Meat Cuts</h4>
                        <p class="text-muted">Beef and Pork that are produces with only natural foods.</p>
                    </div>
                    <div class="col-md-4">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/announcement/2.jpg" alt="..." /></div>
                    ...
                    <div class="col-md-4">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/announcement/3.jpg" alt="..." /></div>
